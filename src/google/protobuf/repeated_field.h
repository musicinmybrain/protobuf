...
class RepeatedField final
 ...
 public:
  ...
  inline RepeatedField(const RepeatedField& rhs)
      : RepeatedField(nullptr, rhs) {}
  ...
  inline RepeatedField(RepeatedField&& rhs) noexcept
      : RepeatedField(nullptr, std::forward<RepeatedField>(rhs)) {}
